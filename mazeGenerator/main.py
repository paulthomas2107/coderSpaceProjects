...
def remove_walls(current, next_one):
    dx = current.x - next_one.x
    if dx == 1:
        current.walls['left'] = False
        next_one.walls['right'] = False
    elif dx == -1:
        current.walls['right'] = False
        next_one.walls['left'] = False
    dy = current.y - next_one.y
    if dy == 1:
        current.walls['top'] = False
        next_one.walls['bottom'] = False
    elif dy == -1:
        current.walls['bottom'] = False
        next_one.walls['top'] = False
